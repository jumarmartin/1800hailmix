-- Mail Rule Action Script for MP3 processing
-- This script is designed to be run by a Mail rule when a message with MP3 attachments arrives
    ...
    on perform mail action with messages theMessages
        repeat with theMessage in theMessages
            ...
            tell application "Mail"
                ...
                if hasMP3 then
                    log "Processing message with MP3 attachment: " & subject of theMessage
